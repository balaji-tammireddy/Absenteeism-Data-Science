...
class absenteeism_model:
    ...
    def __init__(self, model_file, scaler_file):
        # ✅ FIXED HERE (removed quotes)
        with open(model_file, 'rb') as m_file, open(scaler_file, 'rb') as s_file:
            self.reg = pickle.load(m_file)
    ...
    def load_and_clean_data(self, data_file):
        ...
        column_names_upd = ['Reason_1', 'Reason_2', 'Reason_3', 'Reason_4','Month Value', 'Day of the Week','Transportation Expense', 'Distance to Work', 'Age','Daily Work Load Average', 'Body Mass Index', 'Education','Children', 'Pets', 'Absenteeism Time in Hours']
